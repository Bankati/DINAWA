  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        <h1 style={S.title}>Mes biens</h1>
        <p style={S.desc}>La gestion de vos biens immobiliers sera disponible très prochainement. Ajoutez, modifiez et suivez vos propriétés en un seul endroit.</p>
      </div>
    </div>
  );
}
