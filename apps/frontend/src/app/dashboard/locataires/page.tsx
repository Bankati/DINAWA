  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        <h1 style={S.title}>Locataires</h1>
        <p style={S.desc}>La gestion de vos locataires sera disponible très prochainement. Invitez, suivez et gérez vos locataires depuis cet espace.</p>
      </div>
    </div>
  );
}
