...
// connu de la plateforme — un TenantSummary réel = association/gestion pour
// un locataire déjà existant (identité figée). Le gestionnaire a les mêmes
// droits que le propriétaire sur les biens sous mandat ACTIVE — cette page
// réutilise exactement le même endpoint POST /auth/invite/tenant.
      ...
      <Card>
        <DataTable
          ...
          empty={{
            ...
            description: 'Les locataires des biens que vous gérez apparaîtront ici.',
          }}
        />
      </Card>
        ...
        {managing !== 'new' && managing?.activeLease ? (
          ...
          <form onSubmit={submitLink} className="flex flex-col gap-4">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="text-xs text-gray-400 mb-3">Laissez vide pour utiliser les réglages par défaut (Paramètres).</div>
              <div className="grid grid-cols-2 gap-3">
