            ...
            <Card>
              <CardBody>
                ...
                <div className="text-center">
                  <div className="w-18 h-18 rounded-full flex items-center justify-center text-white font-extrabold text-2xl mx-auto mb-3" style={{ background: 'linear-gradient(135deg, #0A2650, #0F4C81)', width: 72, height: 72 }}>
