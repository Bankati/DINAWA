...
export default function GestionnairePaiementsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Paiements"
        subtitle="Validez les déclarations et suivez les encaissements"
        actions={<Button asChild variant="accent"><Link href="/gestionnaire/paiements/manual">+ Paiement manuel</Link></Button>}
      />
          ...
          <Card>
            {loading ? (
              ...
              tenantSearch || statusFilter ? (
                ...
                <EmptyState title="Aucun paiement trouvé" description="Les paiements apparaîtront ici dès leur enregistrement." />
              )
            ) : (
              <Table>
                <TableHeader>
