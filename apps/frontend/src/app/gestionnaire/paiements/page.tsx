  ...
  return (
    <div>
      <PageHeader
        ...
        actions={<Link href="/gestionnaire/paiements/manual"><Button variant="accent">+ Paiement manuel</Button></Link>}
      />
        ...
        <>
          ...
          <Card>
            <DataTable
              ...
              rowKey={(p) => p.id}
              loading={loading}
              empty={{ title: 'Aucun paiement trouvé', description: 'Les paiements apparaîtront ici dès leur enregistrement.' }}
            />
          </Card>
        </>
      )}
