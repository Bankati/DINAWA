      ...
      <div class="bg-white border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h1 class="text-2xl font-bold text-gray-900">{{ bien?.titre || 'Détail du bien' }}</h1>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <p class="text-gray-700">{{ bien.description || 'Aucune description' }}</p>
              </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p class="font-semibold text-gray-900">{{ bien.surface }} m²</p>
                    </div>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-primary-light rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p class="font-semibold text-gray-900">{{ bien.nbPieces }}</p>
                    </div>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-primary-light rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p class="font-semibold text-gray-900">{{ bien.typeBien }}</p>
                    </div>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-primary-light rounded-lg flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <p class="font-semibold text-gray-900">{{ bien.dateCreation | date:'dd/MM/yyyy' }}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="space-y-3">
                  ...
                  @if (bien.charges) {
                    <div class="flex justify-between items-center">
                      ...
                      <lok-montant-fcfa [montant]="bien.charges" size="sm"></lok-montant-fcfa>
                    </div>
                  }
                  <div class="border-t pt-3 flex justify-between items-center">
                    <span class="font-semibold text-gray-900">Total mensuel</span>
                    <lok-montant-fcfa [montant]="bien.loyer + (bien.charges || 0)" size="lg" color="primary"></lok-montant-fcfa>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div class="space-y-2">
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      <p class="font-medium text-gray-900">{{ bien.adresse.quartier }}</p>
                      <p class="text-sm text-gray-600">{{ bien.adresse.ville }}</p>
                      @if (bien.adresse.adresseComplete) {
                        <p class="text-sm text-gray-500">{{ bien.adresse.adresseComplete }}</p>
                      }
                    </div>
                  </div>
                </div>
  ...
  deleteBien(): void {
    this.biensService.deleteBien(this.bienId).subscribe({
      ...
      error: (error: any) => {
        ...
        this.errorMessage = error.error?.message || 'Erreur lors de la suppression du bien';
        this.showDeleteModal = false;
      }
    });
  }
