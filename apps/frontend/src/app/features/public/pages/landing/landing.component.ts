...
@Component({
    ...
    <div class="landing-page">
      ...
      <div class="announce-bar" id="announceBar">
        <div class="announce-content">
          ...
          <span class="announce-text"
            >Offre de lancement &mdash; 3 mois offerts pour les premiers
            inscrits</span
          >
      ...
      <nav class="navbar" id="navbar">
          ...
          <div class="navbar-nav">
            ...
            <div class="nav-dropdown">
              ...
              <div class="nav-dropdown-panel">
                <a
                  href="/auth/register?role=proprietaire"
                  class="dropdown-item"
                >
                  ...
                  <div>
                    ...
                    <div class="dropdown-item-desc">
                      G&#233;rez vos biens, encaissez vos loyers
                    </div>
                  </div>
                </a>
                <a
                  href="/auth/register?role=gestionnaire"
                  class="dropdown-item"
                >
                  <div class="dropdown-item-icon">
                    <svg
                  ...
                  <div>
                    ...
                    <div class="dropdown-item-desc">
                      Pilotez un portefeuille multi-mandants
                    </div>
                  </div>
                </a>
        ...
        <div class="mobile-menu" id="mobileMenu">
          ...
          <a href="/auth/register?role=proprietaire" class="mobile-menu-item"
            >Propri&#233;taires</a
          >
          <a href="/auth/register?role=gestionnaire" class="mobile-menu-item"
            >Gestionnaires</a
          >
          <div class="mobile-menu-divider"></div>
          <a href="/auth/login" class="mobile-menu-item">Connexion</a>
          <a href="/auth/register" class="mobile-menu-item mobile-menu-cta"
            >S&#39;inscrire gratuitement</a
          >
          <a
            href="/annonces/new"
            class="mobile-menu-item mobile-menu-cta-accent"
      ...
      <section class="hero">
        ...
        <div class="hero-content">
          ...
          <p class="hero-subtitle">
            Trouvez votre logement ou gérez vos biens facilement
          </p>
            ...
            <div class="listings-grid">
              ...
              >
                ...
                <div class="listing-content">
                  ...
                  <button class="btn-outline listing-button" tabindex="-1">
                    Voir
                  </button>
                </div>
              </a>
        ...
        <div class="section-container">
          <div class="categories-header">
            ...
            <p class="categories-subtitle">
              Parcourez nos annonces selon le type de logement ou d&#39;espace
              qui vous correspond au Togo
            </p>
          </div>
          ...
          <div class="categories-grid">
            ...
            <a
              href="/annonces?type=appartement"
              class="category-card cat-appartement"
            >
              <div class="cat-icon-wrap">
                <svg
                  viewBox="0 0 24 24"
          ...
          <div class="features-layout">
            <div class="features-text">
              <span class="features-eyebrow"
                >Pour propriétaires &amp; gestionnaires</span
              >
              <h2 class="features-title">Gérez vos biens<br />comme un pro</h2>
              <p class="features-description">
                Simplifiez la gestion locative avec WARAH. Automatisez les
                paiements, suivez vos revenus et gagnez du temps au quotidien.
              </p>
              ...
              <div class="features-list">
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    ...
                    <p class="feature-desc">
                      Tous vos biens, contrats et locataires depuis un seul
                      tableau de bord
                    </p>
                  </div>
                </div>
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    ...
                    <p class="feature-desc">
                      Encaissez vos loyers en ligne et générez des quittances
                      automatiquement
                    </p>
                  </div>
                </div>
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    ...
                    <p class="feature-desc">
                      Suivez vos revenus en temps réel et exportez vos données
                      facilement
                    </p>
                  </div>
                </div>
                <div class="feature-item">
                  ...
                  <div class="feature-content">
                    ...
                    <p class="feature-desc">
                      Alertes pour loyers impayés, fins de contrat et
                      renouvellements
                    </p>
                  </div>
                </div>
              ...
              <div class="features-cta">
                ...
                <a href="/abonnements" class="btn-features-link"
                  >Voir les tarifs →</a
                >
              </div>
            </div>
              ...
              <div class="mockup-card">
                ...
                <div class="mockup-chart">
                  ...
                  <div class="mockup-bars">
                    ...
                    <div
                      class="mockup-bar mockup-bar-accent"
                      style="height:95%"
                    ></div>
                  </div>
                ...
                <div class="mockup-activity">
                  <div class="mockup-activity-item">
                    ...
                    <div class="mockup-activity-text">
                      <div class="mockup-activity-name">
                        Kofi M. — Appart 3P, Lomé
                      </div>
                      <div class="mockup-activity-sub">
                        Loyer reçu · T-Money · Juin
                      </div>
                    </div>
                  ...
                  <div class="mockup-activity-item">
                    ...
                    <span class="mockup-badge mockup-badge-late"
                      >En retard</span
                    >
                  </div>
                </div>
        ...
        <div class="stats-inner">
          ...
          <div class="stats-tagline">
            ...
            <h3 class="stats-heading">
              Des r&#233;sultats concrets, chaque jour
            </h3>
          </div>
        ...
        <div class="section-container">
          ...
          <div class="cities-grid">
            ...
            <a href="/annonces?ville=kpalime" class="city-card">
              <div class="city-image">
                <img
                  src="https://images.unsplash.com/photo-1559827291-72ee739d0d9a?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                  alt="Kpalimé"
                  class="city-img"
                />
              </div>
            ...
            <a href="/annonces?ville=kara" class="city-card">
              <div class="city-image">
                <img
                  src="https://images.unsplash.com/photo-1518391846015-55a9cc003b25?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
                  alt="Kara"
                  class="city-img"
                />
              </div>
          ...
          <div class="testimonials-grid">
            <div class="testimonial-card">
              ...
              <p class="testimonial-text">
                "WARAH a transformé ma gestion locative. Je reçois mes paiements
                à temps et je peux suivre tout en un clic."
              </p>
            ...
            <div class="testimonial-card">
              ...
              <p class="testimonial-text">
                "J'ai trouvé mon appartement en 2 jours grâce à WARAH.
                L'interface est intuitive et les annonces sont de qualité."
              </p>
            ...
            <div class="testimonial-card">
              ...
              <p class="testimonial-text">
                "En tant qu'agent immobilier, WARAH m'aide à gérer le
                portefeuille de mes clients efficacement. Excellent outil !"
              </p>
      ...
      <section class="cta">
        ...
        <div class="cta-container">
          ...
          <p class="cta-subtitle">
            Rejoignez des centaines de propriétaires et locataires sur WARAH
          </p>
          <div class="cta-buttons">
            ...
            >
            <a href="/annonces" class="btn-outline btn-large"
      ...
      <footer class="footer">
        <div class="footer-container">
          <div class="footer-section footer-brand">
            ...
            <p class="footer-description">
              La plateforme immobilière n°1 au Togo. Trouvez votre logement ou
              gérez vos biens facilement.
            </p>
          ...
          <div class="footer-section">
            ...
            <a href="/annonces?type=appartement" class="footer-link"
              >Appartements</a
            >
          ...
          <div class="footer-section">
            ...
            <a href="tel:+22890000000" class="footer-link">
              ...
              >
                <path
                  d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 2 2 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"
                ></path>
              </svg>
              +228 90 00 00 00
            </a>
        ...
        <div class="footer-bottom">
          ...
          <div class="footer-legal">
            <a href="/mentions-legales" class="footer-legal-link"
              >Mentions légales</a
            >
            <span class="footer-legal-sep">•</span>
            <a href="/cgu" class="footer-legal-link">CGU</a>
            <span class="footer-legal-sep">•</span>
            <a href="/confidentialite" class="footer-legal-link"
              >Confidentialité</a
            >
          </div>
        </div>
  ...
  styles: [
    `
      ...
      /* Couleurs par type — variables de marque (marine, or, terracotta, émeraude) */
      .cat-maison {
        --cat-color: var(--color-terracotta);
        --cat-bg: rgba(181, 86, 58, 0.1);
        --cat-border: rgba(181, 86, 58, 0.35);
      }
      .cat-appartement {
        --cat-color: var(--color-primary);
        --cat-bg: rgba(15, 76, 129, 0.1);
        --cat-border: rgba(15, 76, 129, 0.35);
      }
      .cat-bureau {
        --cat-color: var(--color-primary-dark);
        --cat-bg: rgba(10, 38, 80, 0.1);
        --cat-border: rgba(10, 38, 80, 0.35);
      }
      .cat-villa {
        --cat-color: var(--color-emerald);
        --cat-bg: rgba(31, 122, 92, 0.1);
        --cat-border: rgba(31, 122, 92, 0.35);
      }
