        ...
        <div class="topbar-right">
          @if (stats && stats.nombreLitigesOuverts > 0) {
            <a routerLink="/admin/litiges" class="litiges-alert">
              ...
              {{ stats.nombreLitigesOuverts }} litige{{
                stats.nombreLitigesOuverts > 1 ? "s" : ""
              }}
              ouvert{{ stats.nombreLitigesOuverts > 1 ? "s" : "" }}
            </a>
          }
        ...
        <div class="greeting-banner">
          <div>
            ...
            <p class="greeting-sub">
              Supervision en temps réel de l'activité WARAH.
            </p>
          </div>
          ...
          <div class="kpi-grid">
            <div class="kpi-card kpi-blue">
              ...
              <div class="kpi-body">
                ...
                <p class="kpi-trend-up">
                  &#8593; +{{ stats.croissanceUtilisateursMois }}% ce mois
                </p>
              </div>
            </div>
            ...
            <div class="kpi-card kpi-gold">
              ...
              <div class="kpi-body">
                ...
                <lok-montant-fcfa
                  [montant]="stats.volumeTransactionsMois"
                  size="lg"
                  color="primary"
                ></lok-montant-fcfa>
                <p class="kpi-sub">
                  Commissions :
                  <strong
                    >{{ stats.commissionsMois / 1000 | number: "1.0-0" }} k
                    FCFA</strong
                  >
                </p>
              </div>
            ...
            <div class="kpi-card kpi-red">
              ...
              <div class="kpi-body">
                ...
                <p class="kpi-value kpi-red-val">
                  {{ stats.nombreLitigesOuverts }}
                </p>
                <div class="kpi-pills">
                  <a routerLink="/admin/litiges" class="pill pill-red-link"
                    >Voir les litiges</a
                  >
                </div>
              </div>
          ...
          <div class="panels-grid">
            ...
            <div class="section-card">
              <div class="section-header">
                ...
                <a routerLink="/admin/comptes" class="voir-tout"
                  >Voir les comptes</a
                >
              </div>
              <div class="role-list">
                  ...
                  <div class="role-info">
                    <div class="role-header">
                      ...
                      <span class="role-count">{{
                        stats.nombreProprietaires
                      }}</span>
                    </div>
                    <div class="role-bar-bg">
                      <div
                        class="role-bar-fill bar-blue"
                        [style.width.%]="
                          (stats.nombreProprietaires /
                ...
                <div class="role-row">
                  ...
                  <div class="role-info">
                    <div class="role-header">
                      ...
                      <span class="role-count">{{
                        stats.nombreLocataires
                      }}</span>
                    </div>
                    <div class="role-bar-bg">
                      <div
                        class="role-bar-fill bar-green"
                        [style.width.%]="
                          (stats.nombreLocataires / stats.nombreUtilisateurs) *
                          100
                        "
                      ></div>
                    </div>
                ...
                <div class="role-row">
                  ...
                  <div class="role-info">
                    <div class="role-header">
                      ...
                      <span class="role-count">{{
                        stats.nombreGestionnaires
                      }}</span>
                    </div>
                    <div class="role-bar-bg">
                      <div
                        class="role-bar-fill bar-gold"
                        [style.width.%]="
                          (stats.nombreGestionnaires /
                            stats.nombreUtilisateurs) *
                          100
            ...
            <div class="section-card commissions-card">
              <div class="section-header">
                ...
                <a routerLink="/admin/transactions" class="voir-tout"
                  >Voir les transactions</a
                >
              </div>
              <div class="commission-amount">
                <lok-montant-fcfa
                  [montant]="stats.commissionsMois"
                  size="xl"
                  color="primary"
                ></lok-montant-fcfa>
              </div>
              <p class="commission-note">
                Calculées sur l'ensemble des transactions réussies du mois en
                cours.
              </p>
              <div class="commission-detail">
                <div class="comm-detail-row">
                  <span class="comm-detail-label">Volume total</span>
                  <span class="comm-detail-val"
                    >{{
                      stats.volumeTransactionsMois / 1000 | number: "1.0-0"
                    }}
                    k FCFA</span
                  >
                </div>
