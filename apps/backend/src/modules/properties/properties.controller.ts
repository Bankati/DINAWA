...
export class PropertiesController {
  ...
  @Roles(UserRole.OWNER, UserRole.MANAGER)
  @ApiOperation({
    summary: "Publie une annonce publique pour ce bien (désactive l'ancienne si existante)",
  })
  publishListing(
    @CurrentUser() user: AuthenticatedUser,
    @Param('id') id: string,
  ...
  unpublishListing(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string): Promise<void> {
