...
export class ReceiptPdfService {
  ...
  private render(doc: PDFKit.PDFDocument, data: PaymentWithAccess): void {
    ...
    doc
      ...
      .fontSize(24)
      .font('Helvetica-Bold')
      .text('WARAH', M, 22, { lineBreak: false });
    doc
      .fillColor(GOLD)
      .fontSize(8)
      .font('Helvetica')
      .text('GESTION LOCATIVE', M, 52, { lineBreak: false, characterSpacing: 1.5 });
    ...
    doc
      ...
      .fontSize(9)
      .font('Helvetica-Bold')
      .text(propAddress, M + 6, y);
    if (property?.type) {
      doc
        .fillColor(MUTED)
        .fontSize(8)
        .font('Helvetica')
        .text(`Type : ${property.type}`, M + 6, y + 13);
    }
    ...
    const legal =
      'Le bailleur soussigné reconnaît avoir reçu du locataire susnommé la somme indiquée ci-dessus au titre du loyer et des charges pour la période mentionnée, et lui en donne quittance sous réserve de tous ses droits. Cette quittance annule tout reçu provisoire antérieur pour la même période et ne préjuge pas du paiement des loyers à venir.';
    doc
      .fillColor(MUTED)
      .fontSize(7.5)
      .font('Helvetica')
      .text(legal, M + 12, y + 8, { width: CW - 20 });
    ...
    doc
      ...
      .fontSize(8)
      .font('Helvetica')
      .text(`Émis le ${format(new Date(), 'dd MMMM yyyy', { locale: fr })}`, 0, FY + 24, {
        align: 'center',
        width: W,
      });
    doc
      ...
      .fontSize(7)
      .font('Helvetica')
      .text('Document officiel · Plateforme WARAH', 0, FY + 40, {
        align: 'center',
        width: W,
