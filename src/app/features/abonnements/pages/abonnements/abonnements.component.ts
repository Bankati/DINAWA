  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-white border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-sm text-gray-600">Choisissez le plan adapté à vos besoins</p>
          </div>
          <button
      ...
      <div class="p-6 max-w-6xl mx-auto">
        ...
        <!-- Abonnement actuel -->
        @if (abonnementActuel) {
          <div class="bg-gradient-to-r from-primary to-primary-dark text-white rounded-xl p-6 mb-8">
            <div class="flex items-center justify-between">
              <div>
              ...
              <div class="text-right">
                <p class="text-3xl font-bold">
                  <lok-montant-fcfa [montant]="abonnementActuel.prix"></lok-montant-fcfa>
                </p>
        ...
        <!-- Offre de lancement -->
        <div class="bg-secondary-50 border border-secondary text-secondary-800 rounded-xl p-4 mb-8 flex items-center gap-3">
          ...
          <p class="text-sm font-medium">
            Offre de lancement : 3 mois gratuits pendant la phase bêta, puis -50% sur le forfait Starter pendant 3 mois (1 000 FCFA/mois). Changement de forfait gratuit à tout moment.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          @for (plan of plans; track plan.id) {
            <div
              [class]="plan.populaire ? 'border-primary ring-2 ring-primary scale-105' : 'border-gray-200'"
              [class.bg-white]="!plan.populaire"
              [class.bg-gray-50]="plan.populaire"
              class="rounded-xl p-6 border-2 shadow-sm transition-all"
            >
              @if (plan.populaire) {
                <div class="bg-primary text-white text-center py-1 rounded-full text-sm font-semibold mb-4">
                    Plus populaire
                </div>
              }

              <div class="text-center mb-6">
                <h3 class="text-xl font-bold text-gray-900 mb-2">{{ plan.nom }}</h3>
                <div class="mb-2">
              ...
              <ul class="space-y-3 mb-6">
                @for (fonctionnalite of plan.fonctionnalites; track fonctionnalite) {
                  <li class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span class="text-sm text-gray-700">{{ fonctionnalite }}</span>
                  </li>
                }
              </ul>
              ...
              >
                @if (isSubscribing && selectedPlan === plan.id) {
                  ...
                  {{ abonnementActuel?.plan === plan.nom ? 'Changer de plan' : "S'abonner" }}
                }
              </button>
            </div>
          }
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-8">
          <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Comparaison des fonctionnalités</h2>
          </div>
          ...
          <div class="overflow-x-auto">
            <table class="w-full">
              <thead>
                <tr class="bg-gray-50">
                  <th class="px-6 py-3 text-left text-sm font-semibold text-gray-900">Fonctionnalité</th>
                  <th class="px-6 py-3 text-center text-sm font-semibold text-gray-900">Starter</th>
                  <th class="px-6 py-3 text-center text-sm font-semibold text-primary">Pro</th>
                  <th class="px-6 py-3 text-center text-sm font-semibold text-gray-900">Premium</th>
                </tr>
              </thead>
              <tbody class="divide-y divide-gray-200">
                @for (fonctionnalite of fonctionnalitesComparaison; track fonctionnalite.nom) {
                  <tr>
                    <td class="px-6 py-4 text-sm text-gray-900">{{ fonctionnalite.nom }}</td>
...
export class AbonnementsComponent implements OnInit {
  ...
  fonctionnalitesComparaison = [
    ...
    { nom: 'Collecte loyers T-Money/Flooz', starter: true, pro: true, premium: true },
    { nom: 'Quittances PDF automatiques', starter: true, pro: true, premium: true },
    { nom: 'Rappels et alertes impayés', starter: true, pro: true, premium: true },
  ...
  faqs = [
    {
      ...
      reponse: 'Oui, la migration vers un forfait supérieur est gratuite et sans pénalité, à tout moment.'
    },
    {
      question: 'Y a-t-il un engagement de durée ?',
      reponse: 'Non, tous nos abonnements sont sans engagement et sans frais de résiliation.'
    },
    {
      question: 'WARAH prend-il une commission sur mes loyers ?',
      reponse: 'Non. Le forfait est fixe chaque mois, quel que soit le nombre de loyers collectés. 100 % des loyers encaissés vous reviennent intégralement.'
    },
    {
      question: 'Comment puis-je payer mon abonnement ?',
      reponse: 'Le règlement de l\'abonnement se fait par mobile money, via T-Money (Togocom) ou Flooz (Moov Africa).'
    }
  ];

  abonnementActuel: any = {
    plan: 'Starter',
    prix: 2000,
    periode: 'mois',
