              ...
              <div class="table-rows">
                @for (b of derniersBiens; track b.id) {
                  <div class="table-row">
                    ...
                    <div class="row-info">
                      <p class="row-name">{{ b.neighborhood }}</p>
                      <p class="row-sub">{{ b.city }} · {{ b.type }}</p>
                    </div>
                    <div class="row-right">
                      <lok-montant-fcfa [montant]="b.monthlyRent" size="sm"></lok-montant-fcfa>
                      <lok-badge-statut [statut]="b.status"></lok-badge-statut>
                    </div>
                  </div>
                }
              </div>
